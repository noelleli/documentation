...
$xmlPostStr.= '</accountgroupname><showzerobalances>true</showzerobalances></get_accountbalances></function></content></operation></request>';
...
$outputfile = fopen(dirname(__FILE__)."/glbalance".$lastmonth.".xml", 'w+');
