...
$mysenderpwd = $keys::intacctsenderpwd;
$mycompany = 'MAKERMEDIA';
$myuser = $keys::intacctuser;
$mypwd = $keys::intacctpwd;
$controlId  = time();
$sessonId = 'J1m-DXB9dVdLwhp3DeuzZX0nV0rCGg..';
$lastmonth = date("F", strtotime("first day of last month"));
//echo $lastmonth;

$reportingPeriod = "Month Ended ".$lastmonth." 2015";

$query = "period = '".$reportingPeriod."' AND accountno IN ('4400','4401','4403','4404','4405','4407','4409','4411','4413','4415','4417','4419','4421','4423')";
...
$outputfile = fopen(dirname(__FILE__)."/projectbalance".$lastmonth.".xml", 'w+');
...
printf("\nexporting %s projectbalance file: %s. \n", $lastmonth, $current_time);
